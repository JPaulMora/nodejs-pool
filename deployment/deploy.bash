...
cd ~
sudo env PATH=$PATH:`pwd`/.nvm/versions/node/v8.15.0/bin `pwd`/.nvm/versions/node/v8.15.0/lib/node_modules/pm2/bin/pm2 startup systemd -u $CURUSER --hp `pwd`
cd ~/nodejs-pool
...
env PATH=$PATH:`pwd`/.nvm/versions/node/v8.15.0/bin node sql_sync.js
